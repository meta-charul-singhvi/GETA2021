...
public class ArrayOperationMainTest {
	
	//Test cases for largest mirror section.
	@Test
	public void testLargestMirrorSection() throws Exception {
		try { 
	...
	@Test
	public void testNumberOfClumps() throws Exception {
		try { 
	...
	@Test
	public void testFixXYArray() throws Exception {
		try { 
	...
	@Test
	public void testfixXYUnequal() throws Exception {
		try { 
	...
	@Test
	public void testfixXYAdjacent() throws Exception {
		try { 
	...
	@Test
	public void testfixXYLastX() throws Exception {
		try { 
