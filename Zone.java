/*
 * @Zone class cosists of the total capacity of zone, the current capacity of zone and list of cages in the zone.
 */
...
public class Zone {
	 ...
	 *
	 * @typeOfAnimalInCage the type of animal in cage
	 * @nameOfAnimal the name of animal
	 * @ageOfAnimal the age of animal
	 * @weightOfAnimal the weight of animal
	 * @carnivorous the carnivorous
	 * returns true to add animal to cage if successful, false otherwise
	 */
