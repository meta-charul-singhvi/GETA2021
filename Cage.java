...
public class Cage {
	 ...
	 * @carnivorous the carnivorous animals
	 * @typeOfAnimal the type of animal
	 * returns true if animal is added successfully, false otherwise.
	 */
	 ...
	 * @ageOfAnimal the age of animal
	 * @weightOfAnimal the weight of animal
	 * @flight the flight of bird
	 * @typeOfAnimal the type of animal
	 * returns true if animal is successfully added , false otherwise.
	 */
	public Boolean addAnimalToCage(String nameOfAnimal, int ageOfAnimal,
